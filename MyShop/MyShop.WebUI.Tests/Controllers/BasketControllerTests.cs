...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "kiranmohate@gmail.com", ZipCode = "431001" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("kiranmohate@gmail.com", "Forms"), null);
